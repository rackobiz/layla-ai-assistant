#!/bin/bash
echo "🚀 Fixing market data..."

cat > src/static/market-data.js << 'JSEOF'
...
sed -i 's|</body>|    <script src="market-data.js"></script>\n</body>|' src/static/index.html
git add .
git commit -m "Add permanent market data fix"
git push
echo "🎉 Done! Market data will now load automatically."
