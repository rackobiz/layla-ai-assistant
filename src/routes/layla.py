...
Remember: You are not just an assistant - you are a trusted trading partner who actively brings opportunities and insights to help Sharif Metals Group stay ahead in the non-ferrous metals market."""
    ...
    def generate_response(self, user_message, conversation_history=None):
        ...
        try:
            ...
            messages = [
                ...
                {"role": "system", "content": f"Current market data: {json.dumps(market_data)}"}
            ]
    ...
    try:
        ...
        recommendations = [
            ...
            },
            {
                "type": "supplier",
                "metal": "copper_scrap",
                "message": "New supplier identified in India - high-grade copper scrap at competitive rates",
...
def get_market_sentiment():
    ...
    try:
        sentiment = market_provider.get_market_sentiment()
...
def get_arbitrage_opportunities():
    ...
    try:
        opportunities = market_provider.get_arbitrage_opportunities()
...
def get_supply_demand():
    ...
    try:
        indicators = market_provider.get_supply_demand_indicators()
...
def get_trading_recommendation():
    ...
    try:
        ...
        # Get current market data for the metal
        market_data = market_provider.get_metal_price(metal)
